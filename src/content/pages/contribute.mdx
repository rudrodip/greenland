...
# Contribute to GreenLand

Thank you for considering contributing to GreenLand! We appreciate your interest in helping make our platform better and more impactful. This guide outlines the steps for contributing to our GitHub repository.
...
Click on the "Fork" button at the top right corner of the [GreenLand repository](https://github.com/rudrodip/greenland). This will create a copy of the repository in your GitHub account.
...
By contributing to GreenLand, you agree that your contributions will be licensed under the [MIT License](/license).